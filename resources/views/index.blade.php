...
<!--TODO: complementar o dashboard para n ficar vazio e tirar o texto referencia-->
        <div class="d-flex flex-wrap justify-content-center align-items-center">
            ...
            <a href="{{route('parking')}}" class="text-decoration-none">
                <div class="card text-black bg-secondary mb-3 mx-2" style="max-width: 20rem;">
                    <div class="card-header"><i class="fas fa-parking me-2" aria-hidden="true"></i>Estacionadas</div>
                    <div class="card-body">
                        <h4 class="card-title">Cadastro de estacionadas</h4>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the
                            card's content.</p>
                    </div>
